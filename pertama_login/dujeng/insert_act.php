...
if ($foto_size > 2097152) {
	...
	if ($foto_nama != "") {
		...
		if(in_array($ekstensi, $ekstensi_izin) === true)  {
            ...
            // Query untuk memasukan data kedalam table MAHASISWA
            $query = mysqli_query($koneksi, "INSERT INTO Mahasiswa VALUES ('','$nama_lengkap', '$kelas', '$alamat', '$foto_nama_new')");
    	...
    	// Apabila tidak ada file yang diupload maka akan menjalankan code dibawah ini
    	 $query = mysqli_query($koneksi, "INSERT INTO mahasiswa(Mahasiswa_nama, Mahasiswa_kelas, Mahasiswa_alamat) VALUES ('$nama_lengkap Mahasiswa', '$kelas', '$alamat')");
